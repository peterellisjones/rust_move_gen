...
mod test {
    ...
    #[test]
    fn king_pushes() {
        let position = &Position::from_fen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNB1KBNR w").unwrap();
    ...
    #[test]
    fn king_captures() {
        let position = &Position::from_fen("rnbqkbnr/pppppPpp/8/8/8/8/PPPPPPPP/RNB1KBNR b").unwrap();
        let mut list = MoveVec::new();
        king_moves::<MoveVec>(position, !EMPTY, &mut list);
        assert_eq!(list.len(), 1);
    ...
    #[test]
    fn knight_captures() {
        let position = &Position::from_fen("rnbqkbnr/pppppppp/P7/8/8/8/PPPPPPPP/RNBQKBNR b").unwrap();
        let mut list = MoveVec::new();
        knight_moves::<MoveVec>(position, !EMPTY, !EMPTY, &mut list);
        assert_eq!(list.len(), 4);
