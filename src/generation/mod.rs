...
///
/// If you need to verify if a position is in check before generating legal moves then using
...
pub fn movegen_preprocessing(position: &Position) -> MoveGenPreprocessing {
...
mod test {
    ...
    use crate::position::STARTING_POSITION_FEN;
