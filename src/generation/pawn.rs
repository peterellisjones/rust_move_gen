...
use crate::square::SquareInternal;
...
pub const PAWN_CAPTURE_FILE_MASKS: [[(usize, BB); 2]; 2] = [[(7, NOT_FILE_H), (9, NOT_FILE_A)], [
    (64 - 9, NOT_FILE_H),
    (64 - 7, NOT_FILE_A),
]];
...
mod test {
    use super::*;
    use crate::generation::util::{assert_list_excludes_moves, assert_list_includes_moves};
    ...
    fn promotion_captures() {
        ...
        assert_list_includes_moves(&list, &[
            "d2xc1=N", "d2xc1=B", "d2xc1=R", "d2xc1=Q", "d2xe1=N", "d2xe1=B", "d2xe1=R", "d2xe1=Q",
        ]);
    }
}
